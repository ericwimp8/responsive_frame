...
class Selector<A extends InheritedNotifier, S> extends Selector0<S> {
  Selector({
    ...
    super.child,
          ...
          selector: (context) => selector(context, _WithOf.of<A>(context)),
        );
}
...
// TODO(ericwimp): make a small package for this
class _WithOf<T extends Listenable> extends InheritedNotifier<T> {
  const _WithOf({
